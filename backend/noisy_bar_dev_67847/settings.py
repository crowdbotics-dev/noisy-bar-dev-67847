"""
Django settings for noisy_bar_dev_67847 project.
...
ROOT_URLCONF = 'noisy_bar_dev_67847.urls'
...
WSGI_APPLICATION = 'noisy_bar_dev_67847.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "noisy_bar_dev_67847 API",
    "DESCRIPTION": "API documentation for noisy_bar_dev_67847 App",
    "VERSION": "v1",
}
